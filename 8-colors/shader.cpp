...
void Shader::setVec2(const std::string &name, GLfloat* value) const
{
...
void Shader::setMatrix3fv(const std::string &name, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
