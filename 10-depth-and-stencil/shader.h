...
public:
    ...
    */
    ...
    void static lockDepthBuffer();
    void static unlockDepthBuffer();
    void static depthFunctionality(GLenum functionality);

    // OpenGL stencil test functions
    void static enableStencil();
    void static lockStencilBuffer();
    void static unlockStencilBuffer();
    void static stencilFunctionality(GLenum functionality, GLint reference, GLuint mask);
    void static stencilOperation(GLenum sFail, GLenum dpFail, GLenum dpPass);
