...
constexpr static GLenum DEFAULT_TARGET = GL_TEXTURE_2D;
const static std::string DEFAULT_TYPE = "texture_diffuse";
constexpr static GLenum DEFAULT_WRAPPING = GL_REPEAT;
constexpr static GLenum DEFAULT_FILTERING = GL_LINEAR;
...
Texture::Texture(GLuint textureId, GLenum target, std::string type, GLenum wrappingParams, GLenum filterParams, int width, int height, std::string path, GLenum textureUnit)
{
...
void Texture::loadTexture()
{
    ...
    glTexParameteri(target, GL_TEXTURE_MAG_FILTER, filterParams);
