...
public:
    ...
    Texture(GLuint textureId, GLenum target, std::string type, GLenum wrappingParams, GLenum filterParams, int width, int height, std::string path, GLenum textureUnit);
    ~Texture();
